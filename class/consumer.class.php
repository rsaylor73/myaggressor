				...
				if ($sql != "") {
   		      ...
   		      while($row = $result->fetch_assoc()) {
                     ...
                     <?php
                           ...
                           print "<input type=\"image\" src=\"buttons/bt-bookit.png\" name=\"inventoryID_$row[inventoryID]\" id=\"inventoryID_$row[inventoryID]\" onclick=\"quickbook".$row['inventoryID']."(this.form);return false;\">";
								}
								print "
								</form>
								</td>
