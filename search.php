...
?>
   ...
   <div id="reservation-box-inline-wrapper">
      ...
      <div id="reservation-box-inline">
         ...
         <td width=111>
			...
			<td width=121 align=left>
	         <select name="passengers" id="passengers" style="width:85px" class="form-control">
            <?php
            if ($_GET['passengers'] != "") {
      ...
      <div id="reservation-start-input-box">
		...
		<?php
		   $boat_list = "<select name=\"boats[]\" id=\"boats\" multiple size=8 style=\"width:235px;\" class=\"form-control\">";
		?>
...
function selectAll(selectBox,selectAll) { 
    ...
    if (selectBox.type == "select-multiple") { 
      ...
      <div id="reservation-start-input-box-submit">
			...
			<input type="image" src="buttons/bt-hm-search.png" id="submit">
		</form><br>
		<br>
		...
		<?php
			...
			?>
         <input type="image" src="buttons/bt-login.png" id="submit">
			<?php
			} else {
